      ...
      <el-col :md="12" :lg="10" :xl="8">
        <el-form label-position="left" :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="修改头像">
            <el-upload action="/upload" list-type="picture-card" :limit="1" :data="{uid:useruid}" :on-exceed="overFile" :on-preview="handlePictureCardPreview" :on-error="handleError" :on-success="handleSuccess" :before-upload="beforeAvatarUpload">
          ...
          <el-form-item>
            <el-button type="primary" :loading="loading" size="medium" @click="submitForm('ruleForm2')">提交</el-button>
