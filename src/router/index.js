      ...
      permission.forEach(item => {
        ...
        asyncRouter.find(function(s) {
          if (s.path == path) {
            ...
            if (item.child && item.child.length)
              s.redirect = item.child[0].path; //设置重定向路由
...
const routes = [
  ...
  },
  {
    ...
    component: r =>
      require.ensure(
        [],
        () => r(require("../components/page/login/Login.vue")),
        "Login"
      )
  },
  {
    ...
    component: r =>
      require.ensure(
        [],
        () => r(require("../components/page/login/Register.vue")),
        "Register"
      )
  },
  {
    ...
    component: r =>
      require.ensure(
        [],
        () => r(require("../components/page/login/findPass.vue")),
        "findpass"
      )
  },
  {
    ...
    children: [
      {
        ...
        component: r =>
          require.ensure(
            [],
            () => r(require("../components/layout/Home.vue")),
            "Home"
          )
      },
      {
        ...
        component: r =>
          require.ensure(
            [],
            () => r(require("../components/page/login/Admin.vue")),
            "Admin"
          )
      }
    ]
  },
  {
    ...
    component: r =>
      require.ensure(
        [],
        () => r(require("../components/page/error/404.vue")),
        "404"
      )
  }
];
